...
export default function DoctorMedicalRecordDetailPage() {
    ...
    const recordId = Number.isInteger(parsedRecordId) && parsedRecordId > 0
        ? parsedRecordId
        : undefined;
    const { data: record, error, isLoading } =
        useDoctorRecord(recordId);
    ...
    return (
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
            ...
            {record && <MedicalRecordDetail record={record} />}
        </div>
    );
}
