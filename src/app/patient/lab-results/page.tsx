...
import { usePatientLabResults } from "@/features/patient/records/api";
import { PatientLabResultRow } from "@/features/patient/records/patient-lab-result-row";
    ...
    return (
        <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
            ...
            {!showInitialLoading && error && (
                ...
                >
                    <p className="text-sm font-medium text-destructive">
                        Lab results could not be loaded
                    </p>
                ...
                results.length === 0 && (
                    <Empty className="min-h-64">
                        <EmptyHeader>
                            ...
                            <EmptyDescription>
                                Your laboratory results will appear
            ...
            {!error && data && data.totalPages > 1 && (
                <nav
                    aria-label="Lab results pagination"
