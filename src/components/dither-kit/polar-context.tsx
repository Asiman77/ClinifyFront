...
export function usePolarController({
  ...
  // useCallback: dither-kit assumes the React Compiler stabilizes these; this
  // project doesn't enable it, so without stable identities the <Pie>/<Radar>
  // register effects (deps include these) re-fire every render → setState loop
  // → "Maximum update depth exceeded". Manual memoization restores stability.
